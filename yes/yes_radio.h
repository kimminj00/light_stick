...
#define DEFAULT_RETX_COUNT		3       //
//#define DEFAULT_RF_POWER		252
#define DEFAULT_RF_POWER		40
...
void changeRetxCount802154(uint8_t i);  //mjkim add
void changeRetxCountSubG(uint8_t i);    //mjkim add
void setRgbTest();
