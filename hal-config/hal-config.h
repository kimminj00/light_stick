...
// $[PTI]
#define PORTIO_PTI_DFRAME_PIN                 (1U)
#define PORTIO_PTI_DFRAME_PORT                (gpioPortF)
#define PORTIO_PTI_DFRAME_LOC                 (23U)

#define PORTIO_PTI_DOUT_PIN                   (0U)
#define PORTIO_PTI_DOUT_PORT                  (gpioPortF)
#define PORTIO_PTI_DOUT_LOC                   (23U)

#define HAL_PTI_ENABLE                        (1)

#define BSP_PTI_DFRAME_PIN                    (1U)
#define BSP_PTI_DFRAME_PORT                   (gpioPortF)
#define BSP_PTI_DFRAME_LOC                    (23U)

#define BSP_PTI_DOUT_PIN                      (0U)
#define BSP_PTI_DOUT_PORT                     (gpioPortF)
#define BSP_PTI_DOUT_LOC                      (23U)
...
#define PORTIO_USART1_TX_LOC                  (5U)
